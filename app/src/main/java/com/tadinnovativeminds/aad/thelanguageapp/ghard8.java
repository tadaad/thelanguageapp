...
public class ghard8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent bck = new Intent(ghard8.this, choice2.class);
                startActivity(bck);
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(ghard8.this, ghard9.class);
                startActivity(next);
            }
        });
        ...
        vac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard8.this, "WRONG!!!", Toast.LENGTH_SHORT).show();
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard8.this, "Correct! press next to continue", Toast.LENGTH_SHORT).show();
