...
public class ghard9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        one.setText("10/10");
        sa.setText("I am eating");
        saa.setText("I am drinking");
        saaa.setText("I am walking");
        saaaa.setText("i was eating");

        ImageView back = findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bck = new Intent(ghard9.this, choice2.class);
                startActivity(bck);
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(ghard9.this, BossAct.class);
                startActivity(next);
            }
        });
        ...
        vac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard9.this, "Correct! press next to continue", Toast.LENGTH_SHORT).show();
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard9.this, "WRONG!!!", Toast.LENGTH_SHORT).show();
