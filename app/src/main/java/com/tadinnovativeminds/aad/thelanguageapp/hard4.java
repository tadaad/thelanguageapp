...
public class hard4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        one.setText("5/10");
        sa.setText("You are a man");
        saa.setText("you are a girl");
        saaa.setText("you are a boy");
        saaaa.setText("yo are a woman");
        Button next = findViewById(R.id.next);
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(hard4.this, hard5.class);
                startActivity(next);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bck = new Intent(hard4.this, choice.class);
                startActivity(bck);
            }
        });
        ...
        vac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(hard4.this, "Correct! press next to continue", Toast.LENGTH_SHORT).show();
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(hard4.this, "WRONG!!!", Toast.LENGTH_SHORT).show();
