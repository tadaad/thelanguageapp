...
public class ghard7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asa.setText("The Man Is Drinking");
        ...
        one.setText("8/10");
        sa.setText("Der Mann trinkt");
        saa.setText("Der Mann Isst");
        saaa.setText("Der Mann plant");
        saaaa.setText("Der Mann spiet");

        ImageView back = findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bck = new Intent(ghard7.this, choice2.class);
                startActivity(bck);
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(ghard7.this, ghard8.class);
                startActivity(next);
            }
        });
        ...
        vac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard7.this, "Correct! press next to continue", Toast.LENGTH_SHORT).show();
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard7.this, "WRONG!!!", Toast.LENGTH_SHORT).show();
