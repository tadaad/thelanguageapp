...
public class hard6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent bck = new Intent(hard6.this, choice.class);
                startActivity(bck);
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(hard6.this, hard7.class);
                startActivity(next);
            }
        });
        sa.setText("tu leche");
        saa.setText("tu bebo leche");
        saaa.setText("yo bebo milk");
        saaaa.setText("yo bebo leche");
        ...
        vac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(hard6.this, "WRONG!!!", Toast.LENGTH_SHORT).show();
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(hard6.this, "Correct! press next to continue", Toast.LENGTH_SHORT).show();
