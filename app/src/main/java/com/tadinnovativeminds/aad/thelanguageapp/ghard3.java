...
public class ghard3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        one.setText("4/10");
        sa.setText("Der junge");
        saa.setText("Der blitzlichtbirne");
        saaa.setText("Der Block  ");
        saaaa.setText("Der Blockfrie");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next = new Intent(ghard3.this, ghard4.class);
                startActivity(next);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bck = new Intent(ghard3.this, choice2.class);
                startActivity(bck);
            }
        });
        ...
        vac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard3.this, "Correct! press next to continue", Toast.LENGTH_SHORT).show();
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard3.this, "WRONG!!!", Toast.LENGTH_SHORT).show();
