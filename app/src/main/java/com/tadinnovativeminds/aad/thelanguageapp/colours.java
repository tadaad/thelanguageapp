...
public class colours extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new word("mustard yellow", "mostaza amarilla", R.drawable.color_mustard_yellow, R.raw.ellow));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                mMediaPlayer = MediaPlayer.create(colours.this, Word.getmAudioReourceID());
