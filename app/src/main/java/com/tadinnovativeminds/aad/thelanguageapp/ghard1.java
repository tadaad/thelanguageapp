...
public class ghard1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        one.setText("2/10");
        sa.setText("Augmented");
        saa.setText("Exciting");
        saaa.setText("eccentric");
        saaaa.setText("Accent");

        ImageView back = findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bck = new Intent(ghard1.this, choice2.class);
                startActivity(bck);
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(ghard1.this, ghard2.class);
                startActivity(next);
            }
        });
        ...
        vac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard1.this, "WRONG!!!", Toast.LENGTH_SHORT).show();
        ...
        wrong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ghard1.this, "Correct! press next to continue", Toast.LENGTH_SHORT).show();
